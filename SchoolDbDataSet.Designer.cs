...
namespace SouhaSchoolManagementSystem {
    ...
    public partial class SchoolDbDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentTblDataTable : global::System.Data.TypedTableBase<StudentTblRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentTblRow AddStudentTblRow(string StName, string StGen, System.DateTime StDOB, string StClass, int StFees) {
...
namespace SouhaSchoolManagementSystem.SchoolDbDataSetTableAdapters {
    ...
    public partial class StudentTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[StudentTbl] WHERE (([StId] = @Original_StId) AND ([StName] = @" +
                "Original_StName) AND ([StGen] = @Original_StGen) AND ([StDOB] = @Original_StDOB)" +
                " AND ([StClass] = @Original_StClass) AND ([StFees] = @Original_StFees))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[StudentTbl] ([StName], [StGen], [StDOB], [StClass], [StFees]) " +
                "VALUES (@StName, @StGen, @StDOB, @StClass, @StFees);\r\nSELECT StId, StName, StGen" +
                ", StDOB, StClass, StFees FROM StudentTbl WHERE (StId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[StudentTbl] SET [StName] = @StName, [StGen] = @StGen, [StDOB] = @StDOB, [StClass] = @StClass, [StFees] = @StFees WHERE (([StId] = @Original_StId) AND ([StName] = @Original_StName) AND ([StGen] = @Original_StGen) AND ([StDOB] = @Original_StDOB) AND ([StClass] = @Original_StClass) AND ([StFees] = @Original_StFees));
SELECT StId, StName, StGen, StDOB, StClass, StFees FROM StudentTbl WHERE (StId = @StId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SouhaSchoolManagementSystem.Properties.Settings.Default.SchoolDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StId, StName, StGen, StDOB, StClass, StFees FROM dbo.StudentTbl";
        ...
        public virtual int Delete(int Original_StId, string Original_StName, string Original_StGen, System.DateTime Original_StDOB, string Original_StClass, int Original_StFees) {
        ...
        public virtual int Insert(string StName, string StGen, System.DateTime StDOB, string StClass, int StFees) {
            if ((StName == null)) {
        ...
        public virtual int Update(string StName, string StGen, System.DateTime StDOB, string StClass, int StFees, int Original_StId, string Original_StName, string Original_StGen, System.DateTime Original_StDOB, string Original_StClass, int Original_StFees, int StId) {
            if ((StName == null)) {
                throw new global::System.ArgumentNullException("StName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_StId));
            if ((Original_StName == null)) {
                throw new global::System.ArgumentNullException("Original_StName");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_StName));
            }
            if ((Original_StGen == null)) {
                throw new global::System.ArgumentNullException("Original_StGen");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_StGen));
            }
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_StDOB));
            if ((Original_StClass == null)) {
                throw new global::System.ArgumentNullException("Original_StClass");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_StClass));
            }
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_StFees));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(StId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StName, string StGen, System.DateTime StDOB, string StClass, int StFees, int Original_StId, string Original_StName, string Original_StGen, System.DateTime Original_StDOB, string Original_StClass, int Original_StFees) {
            return this.Update(StName, StGen, StDOB, StClass, StFees, Original_StId, Original_StName, Original_StGen, Original_StDOB, Original_StClass, Original_StFees, Original_StId);
        }
    }
